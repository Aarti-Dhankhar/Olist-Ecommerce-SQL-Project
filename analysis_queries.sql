...
On o.order_id = p.order_id GROUP BY o.customer_id ORDER BY total_spending DESC LIMIT 10;
...
-- Q12. Find the best-selling product in each category?
...
-- Q17. What is the total payment amount by payment method?
...
-- Q18. What percentage of total payments comes from each payment method?
...
-- Q19. What is the distribution of review scores?
SELECT review_score , COUNT(*) AS total_reviews FROM order_reviews
GROUP BY review_score 
ORDER BY review_score;

-- Q20. Compare average order value for different payment methods. 
...
-- Q23. What percentage of orders were delivered late?
...
-- Advance Level
-- Q24. Rank customers based on their total spending using RANK(). 
SELECT o.customer_id , SUM(p.payment_value) AS total_spending,
